...
namespace Professional_calculator
{
    public partial class Form1 : Form
    {
        ...
        private Label CurrencyConnection; 
        private Label CurrencyConnection2; 
        ...
        private ComboBox cbCurrencyFrom, cbCurrencyTo;
        private TextBox txtCurrencyInput, txtCurrencyOutput;
        private Button btnConvertCurrency;
        private Label lblCurrencyFrom, lblCurrencyTo;
        ...
        private void AIButton_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Connection2.Width = 200;
            Connection2.Top = 25;
            Connection2.Left = 1000;
        ...
        public void Quality()
        {
            try
            {
                ...
                if (ping.RoundtripTime <= 100 && ping.RoundtripTime >= 1)
                {
                    Connection2.Text = "کیفیت اینترنت: عالی";
                }
                else if (ping.RoundtripTime > 100 && ping.RoundtripTime < 160)
                {
                    Connection2.Text = "کیفیت اینترنت: متوسط";
                }
                else if (ping.RoundtripTime >= 160 && ping.RoundtripTime < 250)
                {
                    Connection2.Text = "کیفیت اینترنت: بد";
                }
                else if (ping.RoundtripTime >= 250)
                {
                    Connection2.Text = "کیفیت اینترنت: خیلی بد";
                }
                else
                {
                    Connection2.Text = ".";
        ...
        private void HelpButton_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            help.Text = "این یه برنامه ماشین حساب پیشرفته هست.\nتوی منو ماشین حساب توی صفحه اصلی، یه سری قابیلت ها به درد بخور برای کار با اعداد در نظر گرفته شده.\n\nتوی منو ماشین حساب میتونی به چهار عمل اصلی، مثلثات، توان، رادیکال، درصد و میانگین گیری دسترسی داشته باشی.\n\nتوی منو تبدیل واحد ها، میتونی همه واحد های طول، مساحت، حجم و وزن رو به همدیگه تبدیل کنی.\n\nتوی منو تبدیل واحد های پول، میتونی واحد پول کشور های مختلف رو به همدیگه تبدیل کنی. البته اینو بگم که برای استفاده از این قسمت به منظور بروز بودن اطلاعات، باید به اینترنت وصل باشی!\n\nتوی قسمت شاخص توده بدن BMI میتونی میزان چاقی خودتو محاسبه کنی.\n\nتوی قسمت هوش مصنوعی اگه چیزی هست که توی منو ها نیست یا هر سوال دیگه ای داری، میتونی از سه مدل هوش مصنوعی DeepSeek، Copilot و Chat GPT بپرسی.\nالبته نکته مهم اینه که با توجه به اینکه Chat GPT ایرانی ها رو تحریم کرده باید یه ابزار تغییر آیپی یا VPN روشن کنی تا بتونی واردش بشی، اما اگه VPN نداری میتونی از دو تا مدل دیگه استفاده کنی.\nبرای استفاده از این قسمت هم باید به اینترنت وصل باشی.\n\nاگه باگ یا مشکلی توی برنامه دیدی یا پیشنهاد و انتقادی داری میتونی اونو گیت هاب من به آدرس https:";
            help.Height = 700;
            help.Width = 1103;
            help.Left = 112;
            help.Top = 100;
        ...
        private void InitializeComponentVideo()
        {
            ...
            this.ClientSize = new System.Drawing.Size(1342, 925);
